...
export function mostrarCapitulo2RutaAlex() {
    ...
    historia.innerHTML = `
        ...
        <div class="container mx-auto mt-4 p-4 pt-6 md:p-6 lg:p-12 xl:p-24 bg-white bg-opacity-50 rounded shadow-md">
            ...
            <p>Pero hoy no se trataba solo de organizar. Había tomado una decisión importante: buscar a Alex, su amigo de la infancia, alguien que había sido más que un camarada, casi un hermano. Si iba a empezar su cruzada contra Capellini y su mafia, no podía hacerlo solo. Y Alex era la persona indicada para dar el primer paso.</p>
            <p>Alex no solo era una de las pocas personas en las que podía confiar, sino que tenía habilidades únicas que podían ser la clave para enfrentar a Capellini. Alex siempre había sido el cerebro del dúo, el chico que desmontaba radios en el orfanato solo para ver cómo funcionaban y que años después había aprendido a hackear sistemas como si fuera un juego.</p>
            <p>El camino hacia donde vivía Alex estaba cargado de recuerdos. Las calles de Santos City eran un mosaico de luces y sombras, de lugares donde habían crecido juntos, riendo, peleando y soñando con una vida mejor. Pero también eran el escenario de la corrupción y el poder que ahora debían enfrentar.</p>
            <p>Cuando llegó, encontró a Alex en una pequeña habitación llena de pantallas y cables, con el teclado de su computadora tamborileando bajo sus dedos. La luz azulada de los monitores iluminaba su rostro, concentrado pero relajado. Alex giró en su silla al escuchar los pasos y levantó una ceja al reconocer a su amigo.</p>
            <p>—¡Vaya! Si es el jefe en persona —dijo Alex, dejando el teclado y cruzando los brazos con una sonrisa burlona—. ¿Qué te trae por aquí? ¿Problemas grandes o gigantes?</p>
            <p>${mostrarNombrePersonaje()} dejó escapar una risa breve, pero en su mirada había una seriedad que Alex no pudo ignorar.</p>
            <p>—Necesito tu ayuda, Alex. Esto es importante.</p>
            <p>Alex se inclinó hacia adelante, su curiosidad evidente. —Me tienes intrigado. Suéltalo.</p>
            <p>${mostrarNombrePersonaje()} no perdió tiempo en rodeos. Le explicó su plan: formar un equipo, enfrentarse a Capellini y tomar el control de Santos City. Era una misión suicida para muchos, pero él sabía que con las habilidades de Alex tenían una oportunidad.</p>
            <p>—¿Quieres que me una a tu mafia? —preguntó Alex, entre incrédulo y divertido—. Sabes que soy un tipo de teclado, no de pistolas, ¿verdad?</p>
            <p>—No necesito que dispares, Alex. Necesito tu cerebro. Capellini tiene un imperio, pero ese imperio está lleno de sistemas, redes y datos. Tú eres el único que puede desmantelarlo desde dentro.</p>
            <p>Alex se rascó la barbilla, pensativo. Por un lado, no podía negar que la idea lo emocionaba; por otro, sabía que esto los pondría en más problemas de los que podía imaginar. Pero el brillo en los ojos de su amigo, esa determinación que no había visto en años, lo convenció.</p>
            <p>—Vale, estoy dentro. Pero que quede claro: si me meto en esto, necesitaré más café y una conexión decente a internet.</p>
            <p>Ambos rieron, relajando la tensión del momento.</p>
            ...
            <button id="continuar-historia-6" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Continuar</button>
        </div>
    `;
    const continuarButton = document.getElementById('continuar-historia-6');
...
function mostrarParte2() {
    historia.innerHTML = `
        <nav id="navbar">
            <div id="pagina-numero">Página 6</div>
            <div id="libro-titulo">The Ascension of The Shadows</div>
            <button onclick="recargarPagina()">Salir</button>
        </nav>
        <div class="container mx-auto mt-4 p-4 pt-6 md:p-6 lg:p-12 xl:p-24 bg-white bg-opacity-50 rounded shadow-md">
            ...
            <p>En la casa abandonada, lejos del bullicio de las sirenas, Alex y ${mostrarNombrePersonaje()} estaban inclinados sobre una mesa improvisada, con un mapa de la ciudad extendido frente a ellos. Alex tamborileaba los dedos contra la madera, su mente claramente procesando algo más rápido de lo que podía expresar.</p>
            <p>—Mira, entiendo la parte de querer construir un equipo —dijo Alex, señalando un punto en el mapa—. Pero si realmente queremos hacer esto, necesitamos a alguien que pueda, ya sabes... pelear. Porque hasta ahora, el plan parece más una partida de ajedrez, y Capellini no juega limpio.</p>
            <p>${mostrarNombrePersonaje()} asintió, trazando líneas con un marcador.</p>
            <p>—Tienes razón. Y sé exactamente a quién necesitamos: Maya.</p>
            <p>Alex dejó escapar un suspiro y rodó los ojos.</p>
            <p>—Maya, claro. Porque nada dice "plan infalible" como reclutar a alguien que probablemente nos meta en más problemas de los que ya tenemos.</p>
            <p>${mostrarNombrePersonaje()} le lanzó una mirada seria, pero con un leve destello de diversión.</p>
            <p>—¿Tienes miedo de que te rompa la nariz otra vez?</p>
            <p>—¡Eso fue un accidente! —protestó Alex, señalando con el dedo acusador—. Además, no tengo miedo.</p>
            <p>Solo digo que la última vez que la vi, estaba ocupada siendo... bueno, Maya.</p>
            <p>${mostrarNombrePersonaje()} guardó silencio por un momento, pensando en la intensidad de Maya y en cómo su enfoque directo contrastaba con la cautela calculadora de Alex.</p>
            <p>—No hay nadie mejor para esto. Vamos.</p>

            <br>

            <p>El gimnasio clandestino donde sabían que encontrarían a Maya estaba impregnado del olor a sudor y metal oxidado. Sonidos de golpes resonaban en el aire mientras boxeadores practicaban en sacos de arena.</p>
            <p>Allí estaba Maya, dominando el centro del lugar como una tormenta. En medio del ring, desarmaba y derribaba a un oponente tras otro con una precisión despiadada. Sus movimientos eran rápidos y letales, un ballet de fuerza y estrategia.</p>
            <p>—¡Wow! Me siento más seguro ya —murmuró Alex, su tono cargado de sarcasmo mientras observaba desde la entrada.</p>
            <p>${mostrarNombrePersonaje()} lo ignoró y se acercó. Maya terminó con su oponente con un barrido limpio y bajó del ring, secándose el sudor de la frente. Al verlo, arqueó una ceja.</p>
            <p>—¿Tú? —dijo, con una mezcla de sorpresa y curiosidad—. ¿Qué haces aquí?</p>
            <p>—Tengo un trabajo para ti —respondió ${mostrarNombrePersonaje()} directamente.</p>
            <p>Ella rió entre dientes, un sonido bajo y peligroso.</p>
            <p>—¿Trabajo? No suelo tomar encargos de viejos amigos que aparecen de la nada.</p>
            <p>—Esto no es un encargo cualquiera. Es una oportunidad. Vamos tras Capellini.</p>
            <p>Maya dejó caer la toalla al suelo, sus ojos brillando con una intensidad que hacía que incluso Alex diera un paso atrás.</p>
            <p>—¿Capellini? ¿Quieres que me meta en eso?</p>
            <p>—Exacto. Pero no podemos hacerlo sin ti —dijo ${mostrarNombrePersonaje()}, su voz firme.</p>
            <p>Ella lo miró por un largo momento antes de sonreír, una sonrisa que no tenía nada de cálida.</p>
            <p>—Vale. Pero si entramos, no hay vuelta atrás. Yo no juego suave.</p>
            <p>—No esperamos que lo hagas —respondió ${mostrarNombrePersonaje()}.</p>
            <p>Alex resopló detrás de ellos.</p>
            <p>—Genial, equipo completo. ¿Alguien más siente que esto es como armar el peor plan de la historia?</p>
            <p>Maya le lanzó una mirada rápida y peligrosa.</p>
            <p>—Tú debes ser el cerebro. Bien, asegúrate de que los números sumen, porque yo no pienso fallar.</p>
            ...
            <button id="continuar-historia-7" class="bg-green-500 text-white font-medium text-lg px-6 py-2 rounded-lg hover:bg-green-600 focus:ring-2 focus:ring-green-300 transition duration-300">
                continuar
            </button>
    ...
    const continuarButton = document.getElementById('continuar-historia-7');
    continuarButton.addEventListener('click', () => {
        mostrarParte3();
...
function mostrarParte3() {
    historia.innerHTML = `
        <nav id="navbar">
            <div id="pagina-numero">Página 7</div>
            <div id="libro-titulo">The Ascension of The Shadows</div>
            <button onclick="recargarPagina()">Salir</button>
        </nav>
        <div class="container mx-auto mt-4 p-4 pt-6 md:p-6 lg:p-12 xl:p-24 bg-white bg-opacity-50 rounded shadow-md">
            ...
            <button id="continuar-historia-8" class="bg-green-500 text-white font-medium text-lg px-6 py-2 rounded-lg hover:bg-green-600 focus:ring-2 focus:ring-green-300 transition duration-300">
                continuar
            </button>
    ...
    const continuarButton = document.getElementById('continuar-historia-8');
    continuarButton.addEventListener('click', () => {
        mostrarParte4();
...
function mostrarParte4() {
    historia.innerHTML = `
        <nav id="navbar">
            <div id="pagina-numero">Página 8</div>
            <div id="libro-titulo">The Ascension of The Shadows</div>
            <button onclick="recargarPagina()">Salir</button>
        </nav>
        <div class="container mx-auto mt-4 p-4 pt-6 md:p-6 lg:p-12 xl:p-24 bg-white bg-opacity-50 rounded shadow-md">
    ...
    elegirCasso.addEventListener('click', () => {
        import('./capitulo_3_ruta_casso.js').then(module => {
            ...
            localStorage.setItem('pagina', '20');
            localStorage.setItem('ruta', 'casso');
            localStorage.setItem('puntoFinalBueno', 2);
